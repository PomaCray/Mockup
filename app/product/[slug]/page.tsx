...
async function getData(slug: string) {
    const query = `*[_types == products && slug.current == '${slug}'][0]{
        _id,
          images,
          price,
          name,
        ...
        <div className="mx-auto max-w-screen-xl px-4 md:px-8">
            <div className="grid gap-8 md:grid-cols-2">
                ...
                <div className="md:py-8">
                  ...
                  <div className="mb-4 flex items-center gap-3 md:mb-10">
                  ...
                  <div className="mb-4">
                    <div className="flex items-end gap-2">
                      ...
                      <span className="mb-0.5 text-red-500 line-through text-xs">${data.price + 30}</span>
                    </div>
                    <span className="text-sm text-gray-500">Inct. Vat plus shipping</span>
                  </div>
